...
public class TargetVector : MonoBehaviour {
	...
	{
		towerBody = this.transform.parent.parent.parent.gameObject.GetComponent<TowerBody> ();
		...
		transform.parent.parent = towerBody.gameObject.transform;
		Destroy (towerBody.transform.FindChild ("Projector Slot").gameObject);
